    ...
    return (
      <div className="bg-white p-4 border border-gray-200 rounded-lg shadow-lg">
        ...
        {payload.map((entry: any, index: number) => {
          let name = '';
          if (entry.dataKey === 'current') name = '上报数（次）';
    ...
    <div className="p-8 max-w-[1600px] mx-auto space-y-4">
      ...
      <div className="card p-6">
        <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-4">
          ...
          <div className="space-y-1">
            <label className="text-sm font-medium text-gray-700">图像量测数据</label>
                    ...
                    <div className="max-h-64 overflow-y-auto">
                      {templates.map(t => (
                        <div 
                          ...
                          className="w-full text-left px-4 py-3 hover:bg-gray-50 border-b border-gray-50 last:border-0 flex justify-between items-center group cursor-pointer"
                        >
                          <div>
